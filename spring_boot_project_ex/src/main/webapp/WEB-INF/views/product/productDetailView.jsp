...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			// 주문액 계산			
			function calAmount(){
				var cartQty = document.getElementById('cartQty'); // 주문수량
				var amount = document.getElementById('amount'); // 주문액
				
				//주문액 = 주문수량 * 상품가격
				var total = qty * ${prd.prdPrice };
								
				cartQty.value = qty; // 변경된 주문수량
				amount.innerHTML = total.toLocaleString(); // 계산액
			}
